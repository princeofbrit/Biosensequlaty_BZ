lag_graph<-function(data){
 ...
 Graph1=ggplot(data=Graph_data, aes(x=as.Date(week), y=Arrival_Visit,group = 1)) + geom_point()+geom_line()+theme_classic()+xlab("Week")+geom_hline(yintercept=24, linetype="dashed", color = "red")
 return(Graph1)
